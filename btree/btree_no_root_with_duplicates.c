...
/*   Updated: 2019/10/16 04:51:37 by kcharla          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
KeyStatus del(node *r, int x, node *root);
void eatline(void);
...
int searchPosAlt(int key, int *key_arr, int n) {
	int pos = 0;
...
KeyStatus del(node *ptr, int key, node *root) {
